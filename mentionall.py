...
keyboard = InlineKeyboardMarkup([
    [
        InlineKeyboardButton("➕Qrupa Əlavə Et➕", url=f"http://t.me/AsqSozTap_bot?startgroup=new")
    ],
    [
        InlineKeyboardButton("📑 Təkliflər", callback_data= "teklif"),
        InlineKeyboardButton("Əmrlər 📚", callback_data= "helps"),
    ],
    [
...
START = """
𓆩𓄂𝙰𝚂𝚀🇦🇿 𝘚𝘰𝘻𝘶 𝘛𝘢𝘱 📕 Botuna xoş gəldin.
